...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 2. AGENTS (3 agents)
        // Agent principal pour tests Postman
        $agentTestUser = User::create([
            'nom' => 'SOW',
            'prenom' => 'Fatou',
        ...
        // 3. TECHNICIENS (4 techniciens avec spécialités différentes)
        // Technicien principal pour tests Postman
        $techTestUser = User::create([
            'nom' => 'DIOUF',
            'prenom' => 'Abdou',
        ...
        // 4. CLIENTS (6 clients : 4 particuliers + 2 entreprises)
        // Client principal pour tests Postman
        $clientTestUser = User::create([
            'nom' => 'DIALLO',
            'prenom' => 'Amadou',
        ...
        $this->command->info('✅ Users seeded: 1 Manager, 3 Agents, 4 Techniciens, 6 Clients');
    }
}
